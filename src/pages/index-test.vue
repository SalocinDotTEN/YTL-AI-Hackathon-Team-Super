      ...
      const uploadToEndpoint = async () => {
        ...
        try {
          const response = await axios.get(
            ...
            'https://puv111.app.n8n.cloud/webhook-test/upload2compareoai?Old%20doc=rmit_2020_06.pdf&New%20doc=rmit_2023_06.pdf',
            {
              headers: {
          ...
          try {
            const analysisResponse = await axios.get(
              ...
              'https://puv111.app.n8n.cloud/webhook-test/analysis?Olddoc=rmit_2020_06.pdf&Newdoc=rmit_2023_06.pdf',
              {
                headers: {
                  'Access-Control-Allow-Origin': '*',
                  'Content-Type': 'text/json',
